...
```shell
git clone git@github.com:ton-community/tlb-editor.git
cd tlb-editor
...
Go [here](https://github.com/ton-community/tlb-editor/fork) to make a fork, then setup your remote:
...
Then create a pull request from the [pull requests page](https://github.com/ton-community/tlb-editor/pulls) or directly:

```shell
https://github.com/ton-community/tlb-editor/pull/new/name-of-your-feature
```
